...
@end
@implementation UIButton (touchLimit)
...
+(void)load
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        SEL newSel = @selector(sendActionWithLimit:to:forEvent:);
        // 获取到上面新建的oldsel方法
...
-(void)sendActionWithLimit:(SEL)action to:(id)target forEvent:(UIEvent *)event
{
    ...
    [self sendActionWithLimit:action to:target forEvent:event];
}
