...
- (void)initial {
    ...
    UIView *separateView = ({
        ...
        tempView.frame = CGRectMake(0, 50 * xl_autoSizeScaleY, XLScreenW, 0.5);
...
//    [self.inputContainerView addSubview:forgetPasswordLabel];
    ...
    self.randomKeyboard = ({
        ...
        randomKeyboard.xl_height = XLScreenW * 0.7;
        randomKeyboard.xl_x = 0;
        randomKeyboard.xl_y = 178 * xl_autoSizeScaleY;
